...
client.connect(function (err, client) {
    ...
    //Insertar los equipos colección equipos
    objEquipos = [{
    ...
    /*
        falta partidos. 
        1. genera resultados aleatorios, por lo que grupos tiene que ser en base a esos resultados
        2. tomar esos resultados aleatorios una vez y pasarlos de forma manual, luego agustar esos resultados en gurpos
        3. en base a los datos ya existentes en grupos, hacer los partidos (que son muchos)
    */
    ...
    /*
    actualizar grupos en colección torneo
